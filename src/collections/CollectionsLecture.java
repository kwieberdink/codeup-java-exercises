...
//        languages.sort(Comparator.comparing(CodingLanguage::getName));
        ...
        careerWins.put("Greg Popovich", 1366);
...
//        System.out.println(careerWins.get("Greg Popovich"));

        // To replace a value, use .replace()

        careerWins.replace("Greg Popovich", 1367);
...
//        HashMap<String,Monster> monsterMap = new HashMap<>();
        ...
        // This is similar to a long series
        ...
        System.out.println(monsterMap.get("Werewolf").getName());
        System.out.println(monsterMap.get("Frost Giant").getDamage());
        ...
        System.out.println(monsterHashMap.get("Frost Giant").getName());
        System.out.println(monsterHashMap.get("Skeleton").getName());

        // Looping over a hashmap directly is not possible. Instead I have to generate sets
        // and then loop over the sets

        // A set is an inordered collection of unique objects
